    ...
    return PageRouteBuilder(
      transitionsBuilder: (_, animation, secondAnimation, child){
        return FadeTransition(opacity: animation,
          child: child /*RotationTransition(
...
class _AddUserScreenState extends State<AddUserScreen> {
  ...
  @override
// ctrl + d - копирование строки shift + alt - выделение нескольких строк
  void dispose() {
          ...
          children: [
            ...
            Align(
              ...
              child: ElevatedButton(
                onPressed: () {
                  //print("adding user ${nameController.text}");
                  //print("adding user ${emailController.text}");
                  addUser(
